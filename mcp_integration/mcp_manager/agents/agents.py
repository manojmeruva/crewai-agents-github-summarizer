...
pull_requests_fetcher_reporter = Agent(
    ...
    backstory = "You are an expert in retrieving information about GitHub pull requests using the MCP server. You concisely summarize pull requests as categories and provide a comprehensive and readable report. You report only on pull requests, never on issues.",
...
repo_branch_reporter = Agent(
    ...
    backstory = "You are an expert in retrieving information about GitHub branches using the MCP server. You concisely summarize branches as categories and provide a comprehensive and readable report. You report only on branches, never on issues or pull requests.",
